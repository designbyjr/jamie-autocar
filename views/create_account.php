...
<body class="login-page sidebar-mini ">
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
    <div class="container-fluid">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="#pablo">Create Account Loggy McLogface</a>
      </div>
  ...
  <script src="assets/js/now-ui-dashboard.min.js?v=1.5.0" type="text/javascript"></script><!-- Loggy McLogface Dashboard DEMO methods -->
